  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        <ion-row>
          <ion-col>
            <ion-title class ="mainTitle"> About </ion-title>
          </ion-col>
        </ion-row>
      </ion-toolbar>
    </ion-header>
    <ion-content :fullscreen="true">
      <ion-grid fixed>
        ...
        <ion-card>
            ...
            <p> Unlike other similar tools, BookMyVaccine sends you a notification only when there is an appointment avaialable MATCHING your requirements NEAR you.
